...
import FirstPassCountChart from '../charts/first-pass-count-bar-chart';
...
export default function FirstRatioCount() {
  return (
    <Container maxWidth="xxl" sx={{ px: 3,mb:0 }}>
      <Typography
        sx={{
          mb: 3,
          color: '#292929',
        ...
        <Table sx={{ width: '100%', borderCollapse: 'collapse' }}>
          <TableHead>
            <TableRow sx={{ backgroundColor: '#0D477A', height: '41px' }}>
              ...
              >
                Counts of Claim <br/> Fixed by Capline
              </TableCell>
              <TableCell 
                rowSpan={2} 
                sx={{
